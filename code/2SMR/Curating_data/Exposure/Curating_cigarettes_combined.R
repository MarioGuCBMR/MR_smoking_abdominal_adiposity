...
#To avoid sample overlap we are using UKB-b-10831. I didn't remember this!!
...
smoking <- extract_instruments(outcomes = "ukb-b-10831", p1 = 0.05, clump = FALSE) #Packs per year
...
#checking that is done properly:

dim(smoking_maf)[1] - dim(smoking_maf_no_mhc)[1] #PERFECT. We detected them properly.
...
head(smoking_maf_no_mhc) #there are some SNPs that need some serious change
...
write.table(smoking_NO_RSID_4_nexus_clean, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/2SMR/Curating_data/Curated_data/CigDayCombined/Cig_Combined_4_Nexus.txt", sep = " ", quote = FALSE, col.names = FALSE, row.names = FALSE)

#None of them in SNPNexus.
#We will check them manually in the matching code.

#So far we leave things how they are.
...
fwrite(smoking_maf_no_mhc, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/2SMR/Curating_data/Curated_data/CigDayCombined/Cig_Day_Combined_Curated.txt")

############################################
#Finally, let's see if we can load the data#
############################################

check <- fread("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/2SMR/Curating_data/Curated_data/CigDayCombined/Cig_Day_Combined_Curated.txt")

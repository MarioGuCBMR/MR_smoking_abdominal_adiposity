...
#1 packyears_smk   wcadjbmi wcadjbmi packyears_smk Wald ratio    1 0.03146754 0.04925354 0.5228952

mr(dat_1_rs16969968)

#id.exposure id.outcome  outcome      exposure     method nsnp          b         se      pval
#1 packyears_smk   wcadjbmi wcadjbmi packyears_smk Wald ratio    1 0.02603699 0.04796288 0.5872282

mr(dat_1_rs1317286)

#id.exposure id.outcome  outcome      exposure     method nsnp          b         se     pval
#1 packyears_smk   wcadjbmi wcadjbmi packyears_smk Wald ratio    1 0.08169957 0.05991302 0.172682

...
#Headers                                    Headers_info beta.exposure se.exposure    logp eaf.exposure
#1: ES:SE:LP:AF:ID 0.0730912:0.00366914:87.5686:0.337514:rs1051730     0.0730912  0.00366914 87.5686     0.337514
#rsid logp_neg pval.exposure
#1: rs1051730 -87.5686  2.700225e-88
...
#Headers                                     Headers_info beta.exposure se.exposure    logp eaf.exposure
#1: ES:SE:LP:AF:ID 0.0729731:0.00367071:87.2147:0.336998:rs16969968     0.0729731  0.00367071 87.2147     0.336998
#rsid logp_neg pval.exposure
#1: rs16969968 -87.2147  6.099581e-88
...
#Headers                                   Headers_info beta.exposure se.exposure   logp eaf.exposure
#1: ES:SE:LP:AF:ID 0.0734398:0.00366497:88.585:0.339506:rs1317286     0.0734398  0.00366497 88.585     0.339506
#rsid logp_neg pval.exposure
#1: rs1317286  -88.585   2.60016e-89
...
dat_1_rs1051730 <- harmonise_data(rs1051730_exp_clean, whr_outcome_rs1051730, action = 3) #1/1: perfect.
dat_1_rs16969968 <- harmonise_data(rs16969968_exp_clean, whr_outcome_rs16969968, action = 3) #1/1: perfect.
dat_1_rs1317286 <- harmonise_data(rs1317286_exp_clean, whr_outcome_rs1317286, action = 3) #1/1: perfect.
...
#1 packyears_smk        whr     whr packyears_smk Wald ratio    1 -0.01094523 0.04788538 0.819202

mr(dat_1_rs16969968)

#id.exposure id.outcome outcome      exposure     method nsnp           b         se     pval
#1 packyears_smk        whr     whr packyears_smk Wald ratio    1 -0.01507405 0.04796288 0.753304

mr(dat_1_rs1317286)

#id.exposure id.outcome outcome      exposure     method nsnp          b         se      pval
#1 packyears_smk        whr     whr packyears_smk Wald ratio    1 0.03267983 0.05991302 0.5854409

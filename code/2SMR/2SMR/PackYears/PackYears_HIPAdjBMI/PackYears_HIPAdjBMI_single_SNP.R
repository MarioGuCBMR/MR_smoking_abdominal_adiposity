...
#1:           15     78894339 rs1051730                     G                      A   . PASS AF=0.337514 ES:SE:LP:AF:ID
#Headers_info beta.exposure se.exposure    logp eaf.exposure      rsid logp_neg pval.exposure
#1: 0.0730912:0.00366914:87.5686:0.337514:rs1051730     0.0730912  0.00366914 87.5686     0.337514 rs1051730 -87.5686  2.700225e-88
...
#chr.exposure pos.exposure        SNP other_allele.exposure effect_allele.exposure dot PASS          AF        Headers
#1:           15     78882925 rs16969968                     G                      A   . PASS AF=0.336998 ES:SE:LP:AF:ID
#Headers_info beta.exposure se.exposure    logp eaf.exposure       rsid logp_neg pval.exposure
#1: 0.0729731:0.00367071:87.2147:0.336998:rs16969968     0.0729731  0.00367071 87.2147     0.336998 rs16969968 -87.2147  6.099581e-88

rs1317286_exp

#chr.exposure pos.exposure       SNP other_allele.exposure effect_allele.exposure dot PASS          AF        Headers
#1:           15     78896129 rs1317286                     A                      G   . PASS AF=0.339506 ES:SE:LP:AF:ID
#Headers_info beta.exposure se.exposure   logp eaf.exposure      rsid logp_neg pval.exposure
#1: 0.0734398:0.00366497:88.585:0.339506:rs1317286     0.0734398  0.00366497 88.585     0.339506 rs1317286  -88.585   2.60016e-89
...
#1 packyears_smk  hipadjbmi hipadjbmi packyears_smk Wald ratio    1 -0.02736308 0.05198984 0.5986688

mr(dat_1_rs16969968)

#3id.exposure id.outcome   outcome      exposure     method nsnp           b         se      pval
#1 packyears_smk  hipadjbmi hipadjbmi packyears_smk Wald ratio    1 -0.02740736 0.05207398 0.5986688

mr(dat_1_rs1317286)

#id.exposure id.outcome   outcome      exposure     method nsnp           b         se     pval
#1 packyears_smk  hipadjbmi hipadjbmi packyears_smk Wald ratio    1 -0.04084978 0.06263634 0.514289

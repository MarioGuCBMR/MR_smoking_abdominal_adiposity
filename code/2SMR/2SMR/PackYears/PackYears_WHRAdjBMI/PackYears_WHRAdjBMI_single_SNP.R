...
#Since the data comes from IEU there is no need to clean anything.
#We are going to keep the ex_clean nomenclature to be consistent.
...
rs16969968_exp_clean$id.exposure <- "Pack years adult smoking"
rs16969968_exp_clean$exposure <- "Pack years adult smoking"

rs1051730_exp_clean$id.exposure <- "Pack years adult smoking"
rs1051730_exp_clean$exposure <- "Pack years adult smoking"

rs1317286_exp_clean$id.exposure <- "Pack years adult smoking"
rs1317286_exp_clean$exposure <- "Pack years adult smoking"
...
dat_1_rs1051730 <- harmonise_data(rs1051730_exp_clean, whradjbmi_outcome_rs1051730, action = 3) #1/1: perfect.
dat_1_rs16969968 <- harmonise_data(rs16969968_exp_clean, whradjbmi_outcome_rs16969968, action = 3) #1/1: perfect.
dat_1_rs1317286 <- harmonise_data(rs1317286_exp_clean, whradjbmi_outcome_rs1317286, action = 3) #1/1: perfect.
...
#1 Pack years adult smoking  whradjbmi whradjbmi Pack years adult smoking Wald ratio    1 0.07251215 0.04925354 0.1409609

mr(dat_1_rs16969968)

#id.exposure id.outcome   outcome                 exposure     method nsnp         b         se      pval
#1 Pack years adult smoking  whradjbmi whradjbmi Pack years adult smoking Wald ratio    1 0.0685184 0.04796288 0.1531275

mr(dat_1_rs1317286)

#id.exposure id.outcome   outcome                 exposure     method nsnp         b         se       pval
#1 Pack years adult smoking  whradjbmi whradjbmi Pack years adult smoking Wald ratio    1 0.1225494 0.05991302 0.04081007

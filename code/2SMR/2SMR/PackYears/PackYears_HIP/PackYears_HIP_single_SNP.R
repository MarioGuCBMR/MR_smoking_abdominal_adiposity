...
#1:           15     78894339 rs1051730                     G                      A   . PASS
#AF        Headers                                    Headers_info beta.exposure
#1: AF=0.337514 ES:SE:LP:AF:ID 0.0730912:0.00366914:87.5686:0.337514:rs1051730     0.0730912
#se.exposure    logp eaf.exposure      rsid logp_neg pval.exposure
#1:  0.00366914 87.5686     0.337514 rs1051730 -87.5686  2.700225e-88
...
#chr.exposure pos.exposure        SNP other_allele.exposure effect_allele.exposure dot PASS
#1:           15     78882925 rs16969968                     G                      A   . PASS
#AF        Headers                                     Headers_info beta.exposure
#1: AF=0.336998 ES:SE:LP:AF:ID 0.0729731:0.00367071:87.2147:0.336998:rs16969968     0.0729731
#se.exposure    logp eaf.exposure       rsid logp_neg pval.exposure
#1:  0.00367071 87.2147     0.336998 rs16969968 -87.2147  6.099581e-88

rs1317286_exp

#chr.exposure pos.exposure       SNP other_allele.exposure effect_allele.exposure dot PASS
#1:           15     78896129 rs1317286                     A                      G   . PASS
#AF        Headers                                   Headers_info beta.exposure
#1: AF=0.339506 ES:SE:LP:AF:ID 0.0734398:0.00366497:88.585:0.339506:rs1317286     0.0734398
#se.exposure   logp eaf.exposure      rsid logp_neg pval.exposure
#1:  0.00366497 88.585     0.339506 rs1317286  -88.585   2.60016e-89
...
hip_2_rs1051730 <- hip[which(hip$MarkerName%in%rs1051730_exp$SNP),] #gotcha
hip_2_rs16969968 <- hip[which(hip$MarkerName%in%rs16969968_exp$SNP),] #gotcha
hip_2_rs1317286 <- hip[which(hip$MarkerName%in%rs1317286_exp$SNP),] #gotcha
...
#1 packyears_smk        hip     hip packyears_smk Wald ratio    1 -0.1080841 0.05198984
#pval
#1 0.03762219

mr(dat_1_rs16969968)

#1 packyears_smk        hip     hip packyears_smk Wald ratio    1 -0.1109998 0.05070362
#pval
#1 0.02858309
...
#id.exposure id.outcome outcome      exposure     method nsnp          b         se
#1 packyears_smk        hip     hip packyears_smk Wald ratio    1 -0.1252727 0.06263634
#pval
#1 0.04550026
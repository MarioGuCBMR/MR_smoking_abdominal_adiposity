...
#1 lifetime_smk         wc      wc lifetime_smk Wald ratio    1 -0.3164108 0.1963929 0.1071555

mr(dat_1_rs16969968)

#id.exposure id.outcome outcome     exposure     method nsnp          b       se       pval
#1 lifetime_smk         wc      wc lifetime_smk Wald ratio    1 -0.3337856 0.193811 0.08502927

mr(dat_1_rs1317286)

#id.exposure id.outcome outcome     exposure     method nsnp          b        se      pval
#1 lifetime_smk         wc      wc lifetime_smk Wald ratio    1 -0.2867764 0.2434894 0.2388852

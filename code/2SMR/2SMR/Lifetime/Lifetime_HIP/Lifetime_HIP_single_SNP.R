...
#1 lifetime_smk        hip     hip lifetime_smk Wald ratio    1 -0.4309733 0.2073036 0.03762219

mr(dat_1_rs16969968)

#id.exposure id.outcome outcome     exposure     method nsnp          b        se       pval
#1 lifetime_smk        hip     hip lifetime_smk Wald ratio    1 -0.4360747 0.1991946 0.02858309

mr(dat_1_rs1317286)

#id.exposure id.outcome outcome     exposure     method nsnp          b        se       pval
#1 lifetime_smk        hip     hip lifetime_smk Wald ratio    1 -0.4978005 0.2489002 0.04550026

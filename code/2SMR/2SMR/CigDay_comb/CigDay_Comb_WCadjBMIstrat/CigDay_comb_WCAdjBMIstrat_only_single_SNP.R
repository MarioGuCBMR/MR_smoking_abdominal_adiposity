...
WCAdjBMI_2_rs1051730 <- WCAdjBMI[which(WCAdjBMI$rs_id%in%rs1051730_exp$RSID),] #gotcha
WCAdjBMI_2_rs16969968 <- WCAdjBMI[which(WCAdjBMI$rs_id%in%rs16969968_exp$RSID),] #gotcha
WCAdjBMI_2_rs1317286 <- WCAdjBMI[which(WCAdjBMI$rs_id%in%rs1317286_exp$RSID),] #gotcha
...
colnames(WCAdjBMI_outcome_rs1051730) <- c("chr.outcome", "SNP", "marker", "pos_18", "effect_allele.outcome", 
...
colnames(WCAdjBMI_outcome_rs16969968) <-c("chr.outcome", "SNP", "marker", "pos_18", "effect_allele.outcome", 
                                           "other_allele.outcome", "eaf.outcome", "samplesize.outcome", "beta.outcome", "se.outcome",
                                           "pval.outcome", "samplesize_NO.outcome",  "beta_NO.outcome", "se_NO.outcome",
                                           "pval_NO.outcome","chr_pos_37", "chr_pos_18")
...
colnames(WCAdjBMI_outcome_rs1317286) <- c("chr.outcome", "SNP", "marker", "pos_18", "effect_allele.outcome", 
                                           "other_allele.outcome", "eaf.outcome", "samplesize.outcome", "beta.outcome", "se.outcome",
                                           "pval.outcome", "samplesize_NO.outcome",  "beta_NO.outcome", "se_NO.outcome",
                                           "pval_NO.outcome","chr_pos_37", "chr_pos_18")
...
#1         CIG   WCAdjBMI WCAdjBMI      CIG Wald ratio    1 0.03676535 0.04456405 0.4093716

mr(dat_1_rs16969968)
#id.exposure id.outcome  outcome exposure     method nsnp         b         se      pval
#1         CIG   WCAdjBMI WCAdjBMI      CIG Wald ratio    1 0.0469871 0.04419025 0.2876499

mr(dat_1_rs1317286)
#id.exposure id.outcome  outcome exposure     method nsnp          b         se       pval
#1         CIG   WCAdjBMI WCAdjBMI      CIG Wald ratio    1 0.09207008 0.04854604 0.05788713

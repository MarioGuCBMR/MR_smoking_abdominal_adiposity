...
hipadjbmi_2_rs1051730 <- hipadjbmi[which(hipadjbmi$MarkerName%in%rs1051730_exp$RSID),] #gotcha
hipadjbmi_2_rs16969968 <- hipadjbmi[which(hipadjbmi$MarkerName%in%rs16969968_exp$RSID),] #gotcha
hipadjbmi_2_rs1317286 <- hipadjbmi[which(hipadjbmi$MarkerName%in%rs1317286_exp$RSID),] #gotcha
...
#1         SMK  hipadjbmi hipadjbmi      SMK Wald ratio    1 0.1948541 0.3702228 0.5986688

mr(dat_1_rs16969968)

#id.exposure id.outcome   outcome exposure     method nsnp         b        se      pval
#1         SMK  hipadjbmi hipadjbmi      SMK Wald ratio    1 0.2081269 0.3954412 0.5986688

mr(dat_1_rs1317286)

#id.exposure id.outcome   outcome exposure     method nsnp         b        se     pval
#1         SMK  hipadjbmi hipadjbmi      SMK Wald ratio    1 0.3056579 0.4686755 0.514289

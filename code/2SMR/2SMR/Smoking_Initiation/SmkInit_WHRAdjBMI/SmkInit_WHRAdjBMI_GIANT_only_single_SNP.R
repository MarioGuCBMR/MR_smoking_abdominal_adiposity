...
WHRAdjBMI_2_rs1051730 <- WHRAdjBMI[which(WHRAdjBMI$MarkerName%in%rs1051730_exp$RSID),] #gotcha
WHRAdjBMI_2_rs16969968 <- WHRAdjBMI[which(WHRAdjBMI$MarkerName%in%rs16969968_exp$RSID),] #gotcha
WHRAdjBMI_2_rs1317286 <- WHRAdjBMI[which(WHRAdjBMI$MarkerName%in%rs1317286_exp$RSID),] #gotcha
...
#Analysing 'SMK' on 'WHRAdjBMI'
#id.exposure id.outcome   outcome exposure     method nsnp          b        se      pval
#1         SMK  WHRAdjBMI WHRAdjBMI      SMK Wald ratio    1 -0.5163634 0.3507374 0.1409609

mr(dat_1_rs16969968)
#Analysing 'SMK' on 'WHRAdjBMI'
#id.exposure id.outcome   outcome exposure     method nsnp          b        se      pval
#1         SMK  WHRAdjBMI WHRAdjBMI      SMK Wald ratio    1 -0.5203173 0.3642221 0.1531275

mr(dat_1_rs1317286)

#Analysing 'SMK' on 'WHRAdjBMI'
#id.exposure id.outcome   outcome exposure     method nsnp          b        se       pval
#1         SMK  WHRAdjBMI WHRAdjBMI      SMK Wald ratio    1 -0.9169738 0.4482983 0.04081007

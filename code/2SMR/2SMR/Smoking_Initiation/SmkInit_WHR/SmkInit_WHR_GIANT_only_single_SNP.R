...
whr_2_rs1051730 <- whr[which(whr$MarkerName%in%rs1051730_exp$RSID),] #gotcha
whr_2_rs16969968 <- whr[which(whr$MarkerName%in%rs16969968_exp$RSID),] #gotcha
whr_2_rs1317286 <- whr[which(whr$MarkerName%in%rs1317286_exp$RSID),] #gotcha
...
dat_1_rs1051730 <- harmonise_data(rs1051730_exp_clean, whr_outcome_rs1051730, action = 3) 
dat_1_rs16969968 <- harmonise_data(rs16969968_exp_clean, whr_outcome_rs16969968, action = 3) 
dat_1_rs1317286 <- harmonise_data(rs1317286_exp_clean, whr_outcome_rs1317286, action = 3) 
...
#1         SMK        whr     whr      SMK Wald ratio    1 0.07794164 0.3409947 0.819202

mr(dat_1_rs16969968)

#id.exposure id.outcome outcome exposure     method nsnp         b        se     pval
#1         SMK        whr     whr      SMK Wald ratio    1 0.1144698 0.3642221 0.753304

mr(dat_1_rs1317286)

#id.exposure id.outcome outcome exposure     method nsnp          b        se      pval
#1         SMK        whr     whr      SMK Wald ratio    1 -0.2445264 0.4482983 0.5854409

#NEGATIVE, NOT SIGNIFICANT. VERY WEIRD.

...
#We are going to run CAUSE for PacksPerYearInit as exposure and HIPadjBMI as outcome
...
which(HIPadjBMI_missing$MarkerName%in%PacksPerYear_$SNP) #none of them. 
...
X <- gwas_merge(PacksPerYear_, HIPadjBMI, snp_name_cols = c("chr_pos", "chr_pos_37"), 
...
HIPadjBMI[which(HIPadjBMI$chr_pos_37 == "chr17:21949792"),] #PERFECT. Also checked in PS.
...
head(PacksPerYear_match)
head(X)
tail(PacksPerYear_match)
tail(X)

#Careful. PacksPerYear might have some chr_pos that do not present RSID.
...
saveRDS(params, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/PacksPerYear/dataframes/params_PacksPerYear_HIPadjBMI.rds")
saveRDS(X_end, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/PacksPerYear/dataframes/X_PacksPerYear_HIPadjBMI.rds")

params <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/PacksPerYear/dataframes/params_PacksPerYear_HIPadjBMI.rds")
X_end <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/PacksPerYear/dataframes/X_PacksPerYear_HIPadjBMI.rds")
...
PacksPerYear_pruned <- PacksPerYear_[which(PacksPerYear_$SNP%in%pruned_all),] #they are all here, no need of weird stuff.

write.table(PacksPerYear_pruned, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/PacksPerYear/dataframes/PacksPerYear_HIPadjBMI_PRUNED.txt", col.names = TRUE, row.names = FALSE, quote = FALSE)

#################
#Let's run CAUSE#
#################

top_PacksPerYear_pruned_df <- read.table("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/PacksPerYear/dataframes/PacksPerYear_HIPadjBMI_PRUNED.txt", header = TRUE, stringsAsFactors = FALSE)
...
saveRDS(res, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/PacksPerYear/dataframes/RES_PacksPerYear_to_HIPadjBMI_FULL.rds")

res <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/PacksPerYear/dataframes/RES_PacksPerYear_to_HIPadjBMI_FULL.rds")

res$elpd

#model1  model2 delta_elpd se_delta_elpd        z
#1    null sharing  0.6692667     0.2160318 3.098001
#2    null  causal  1.5257727     0.5423174 2.813431
#3 sharing  causal  0.8565060     0.3497611 2.448832

#Sounds really promising:

summary(res)

#p-value testing that causal model is a better fit:  0.99 
#Posterior medians and  95 % credible intervals:
#  model     gamma                 eta                   q               
#[1,] "Sharing" NA                    "-0.03 (-0.67, 0.69)" "0.09 (0, 0.67)"
#[2,] "Causal"  "-0.01 (-0.13, 0.11)" "0 (-0.57, 0.6)"      "0.17 (0, 0.87)"

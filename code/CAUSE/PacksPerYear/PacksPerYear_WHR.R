...
#We are going to run CAUSE for PacksPerYear as exposure and WHR as outcome
...
WHR <- fread("C:/Users/zlc436/Desktop/PULIT_data_reservoir/Combined/whr.giant-ukbb.meta-analysis.combined.23May2018.txt.gz")
...
#We already recovered these bad boys in the lifetime-WHR set so we are going to use them:
...
X_UKBB <- gwas_merge(PacksPerYear_, WHR_, snp_name_cols = c("chr_pos", "chr_pos"), 
...
WHR_[which(WHR_$chr_pos == "7:92383888"),] #PERFECT.
...
saveRDS(params, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/PacksPerYear/dataframes/params_PacksPerYear_WHR.rds")
saveRDS(X_end, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/PacksPerYear/dataframes/X_PacksPerYear_WHR.rds")

X_end <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/PacksPerYear/dataframes/X_PacksPerYear_WHR.rds")
params <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/PacksPerYear/dataframes/params_PacksPerYear_WHR_JULY.rds")
...
write.table(PacksPerYear_pruned, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/PacksPerYear/dataframes/PacksPerYear_WHR_PRUNED.txt", col.names = TRUE, row.names = FALSE, quote = FALSE)

#################
#Let's run CAUSE#
#################

top_PacksPerYear_pruned_df <- read.table("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/PacksPerYear/dataframes/PacksPerYear_WHR_PRUNED.txt", header = TRUE, stringsAsFactors = FALSE)
...
saveRDS(res, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/PacksPerYear/dataframes/RES_PacksPerYear_to_WHR_FULL.rds")

res <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/PacksPerYear/dataframes/RES_PacksPerYear_to_WHR_FULL.rds")

res$elpd

#model1  model2  delta_elpd se_delta_elpd         z
#1    null sharing -35.2874320     8.1146363 -4.348615
#2    null  causal -34.4700131     8.4312482 -4.088364
#3 sharing  causal   0.8174188     0.7960502  1.026843

#Sounds really promising:

summary(res)

#p-value testing that causal model is a better fit:  0.85 
#Posterior medians and  95 % credible intervals:
#  model     gamma               eta                  q                  
#[1,] "Sharing" NA                  "0.24 (0.18, 0.3)"   "0.75 (0.56, 0.89)"
#[2,] "Causal"  "0.22 (-0.01, 0.3)" "-0.2 (-0.28, 0.27)" "0.3 (0.09, 0.83)" 

...
which(WC_missing$MarkerName%in%SMK_$RSID) #none of them. 
...
X <- gwas_merge(SMK_, WC, snp_name_cols = c("chr_pos", "chr_pos_37"), 
...
saveRDS(params, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Smoking_Initiation/dataframes/params_SMKInit_WC.rds")
saveRDS(X_end, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Smoking_Initiation/dataframes/X_SMKInit_WC.rds")
...
write.table(SMK_pruned, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Smoking_Initiation/dataframes/SMKInit_WC_PRUNED.txt", col.names = TRUE, row.names = FALSE, quote = FALSE)

#################
#Let's run CAUSE#
#################

top_smk_pruned_df <- read.table("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Smoking_Initiation/dataframes/SMKInit_WC_PRUNED.txt", header = TRUE, stringsAsFactors = FALSE)
...
saveRDS(res, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Smoking_Initiation/dataframes/RES_SMKinit_to_WC_FULL.rds")

res <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Smoking_Initiation/dataframes/RES_SMKinit_to_WC_FULL.rds")

res$elpd

#model1  model2  delta_elpd se_delta_elpd         z
#1    null sharing -15.6516487     5.0732946 -3.085105
#2    null  causal -16.5221613     5.5753802 -2.963414
#3 sharing  causal  -0.8705126     0.5247626 -1.658869
...
#  model     gamma               eta                 q                  
#[1,] "Sharing" NA                  "0.11 (0.06, 0.19)" "0.68 (0.32, 0.94)"
#[2,] "Causal"  "0.08 (0.01, 0.14)" "0 (-0.28, 0.33)"   "0.19 (0, 0.85)"   

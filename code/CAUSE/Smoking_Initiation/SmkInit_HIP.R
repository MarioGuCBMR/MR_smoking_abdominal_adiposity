...
which(HIP_missing$MarkerName%in%SMK_$RSID) #none of them. 
...
X <- gwas_merge(SMK_, HIP, snp_name_cols = c("chr_pos", "chr_pos_37"), 
...
saveRDS(params, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Smoking_Initiation/dataframes/params_SMKInit_HIP.rds")
saveRDS(X_end, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Smoking_Initiation/dataframes/X_SMKInit_HIP.rds")
...
write.table(SMK_pruned, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Smoking_Initiation/dataframes/SMKInit_HIP_PRUNED.txt", col.names = TRUE, row.names = FALSE, quote = FALSE)

#################
#Let's run CAUSE#
#################

top_smk_pruned_df <- read.table("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Smoking_Initiation/dataframes/SMKInit_HIP_PRUNED.txt", header = TRUE, stringsAsFactors = FALSE)
...
saveRDS(res, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Smoking_Initiation/dataframes/RES_SMKinit_to_HIP_FULL.rds")

res <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Smoking_Initiation/dataframes/RES_SMKinit_to_HIP_FULL.rds")

res$elpd

#model1  model2 delta_elpd se_delta_elpd          z
#1    null sharing -4.1219618     2.7173863 -1.5168847
#2    null  causal -4.6256831     3.2877675 -1.4069374
#3 sharing  causal -0.5037213     0.5827899 -0.8643273
...
#  model     gamma                eta                 q                  
#[1,] "Sharing" NA                   "0.09 (0.03, 0.28)" "0.42 (0.07, 0.87)"
#[2,] "Causal"  "0.04 (-0.02, 0.12)" "0 (-0.29, 0.35)"   "0.19 (0, 0.86)"   

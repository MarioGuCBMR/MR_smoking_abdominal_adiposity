...
#We are going to run CAUSE for SmkInit as exposure and WCAdjBMI as outcome
...
which(WCAdjBMI_missing$MarkerName%in%SMK_$RSID) #none of them. 
...
X <- gwas_merge(SMK_, WCAdjBMI, snp_name_cols = c("chr_pos", "chr_pos_37"), 
...
saveRDS(params, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Smoking_Initiation/dataframes/params_SMKInit_WCAdjBMI.rds")
saveRDS(X_end, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Smoking_Initiation/dataframes/X_SMKInit_WCAdjBMI.rds")
...
write.table(SMK_pruned, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Smoking_Initiation/dataframes/SMKInit_WCAdjBMI_PRUNED.txt", col.names = TRUE, row.names = FALSE, quote = FALSE)

#################
#Let's run CAUSE#
#################

top_smk_pruned_df <- read.table("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Smoking_Initiation/dataframes/SMKInit_WCAdjBMI_PRUNED.txt", header = TRUE, stringsAsFactors = FALSE)
...
saveRDS(res, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Smoking_Initiation/dataframes/RES_SMKinit_to_WCAdjBMI_FULL.rds")

res <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Smoking_Initiation/dataframes/RES_SMKinit_to_WCAdjBMI_FULL.rds")

res$elpd

#model1  model2 delta_elpd se_delta_elpd          z
#1    null sharing  -3.517133     2.7071828 -1.2991855
#2    null  causal  -3.863970     3.2035292 -1.2061603
#3 sharing  causal  -0.346837     0.5340766 -0.6494144

#Sounds really promising:

summary(res)

#p-value testing that causal model is a better fit:  0.26 
#Posterior medians and  95 % credible intervals:
#  model     gamma                eta                q                  
#[1,] "Sharing" NA                   "0.09 (0.02, 0.3)" "0.33 (0.05, 0.83)"
#[2,] "Causal"  "0.03 (-0.04, 0.11)" "0 (-0.31, 0.34)"  "0.19 (0, 0.84)"    

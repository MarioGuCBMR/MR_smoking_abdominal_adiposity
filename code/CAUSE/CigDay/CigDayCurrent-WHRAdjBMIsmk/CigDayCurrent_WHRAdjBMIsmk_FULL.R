...
CigDay_mhc <- CigDay[which(CigDay$chr.exposure == 6 & CigDay$pos.exposure >= 26000000 & CigDay$pos.exposure <= 34000000),]
...
head(WHRAdjBMI$chr_pos_37) #we will check later if they match.
...
which(WHRAdjBMI_not_liftover_weird$rs_id%in%CigDay$SNP) #none of them. 
...
X <- gwas_merge(CigDay, WHRAdjBMI, snp_name_cols = c("chr_pos", "chr_pos_37"), 
...
WHRAdjBMI_rare <- WHRAdjBMI[which(WHRAdjBMI$chr_pos_37%in%CigDay_match_rare$chr_pos),] #23
...
length(which(CigDay_match_normal$chr_pos == X_normal$snp)) #1942821
...
WHRAdjBMI[which(WHRAdjBMI$rs_id == "rs3750595"),] #PERFECT.
CigDay[which(CigDay$SNP == "rs3750595"),] #PERFECT

#Careful last SNP does not have RSID in CigDay:

WHRAdjBMI[which(WHRAdjBMI$rs_id == "rs4005780"),] #PERFECT.
...
saveRDS(params, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/CigDay/CigDayCurrent-WHRAdjBMIsmk/dataframes/params_CigDayCurrent_WHRAdjBMIsmk_FULL.rds")
saveRDS(X_end, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/CigDay/CigDayCurrent-WHRAdjBMIsmk/dataframes/X_CigDayCurrent_WHRAdjBMIsmk_FULL.rds")

check <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/CigDay/CigDayCurrent-WHRAdjBMIsmk/dataframes/params_CigDayCurrent_WHRAdjBMIsmk.rds")
...
write.table(CigDay_pruned, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/CigDay/CigDayCurrent-WHRAdjBMIsmk/dataframes/CigDayCurrent_WHRAdjBMIsmk_PRUNED_FULL.txt", col.names = TRUE, row.names = FALSE, quote = FALSE, sep = ",")

#################
#Let's run CAUSE#
#################

top_CigDay_pruned_df <- read.table("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/CigDay/CigDayCurrent-WHRAdjBMIsmk/dataframes/CigDayCurrent_WHRAdjBMIsmk_PRUNED_FULL.txt", header = TRUE, stringsAsFactors = FALSE, sep = ",")
...
saveRDS(res, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/CigDay/CigDayCurrent-WHRAdjBMIsmk/dataframes/RES_CigDayCurrent_to_WHRAdjBMIsmk_FULL_VCF.rds")

res <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/CigDay/CigDayCurrent-WHRAdjBMIsmk/dataframes/RES_CigDayCurrent_to_WHRAdjBMIsmk_FULL_VCF.rds")

res$elpd

#model1  model2 delta_elpd se_delta_elpd         z
#1    null sharing  0.5035474     0.3762735 1.3382484
#2    null  causal  0.6974284     1.2766235 0.5463070
#3 sharing  causal  0.1938810     0.9207698 0.2105641

#Sounds really promising:

summary(res)

#p-value testing that causal model is a better fit:  0.58 
#Posterior medians and  95 % credible intervals:
#  model     gamma                eta                   q                  
#[1,] "Sharing" NA                   "0.09 (-1.44, 1)"     "0.15 (0.01, 0.74)"
#[2,] "Causal"  "0.08 (-0.47, 0.27)" "-0.17 (-1.56, 0.91)" "0.19 (0.01, 0.85)"

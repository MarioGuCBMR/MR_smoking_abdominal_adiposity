...
#We are going to run CAUSE for LifetimeInit as exposure and HIPadjBMI as outcome
...
which(HIPadjBMI_missing$MarkerName%in%Lifetime_$RSID) #none of them. 
...
X <- gwas_merge(Lifetime_, HIPadjBMI, snp_name_cols = c("chr_pos", "chr_pos_37"), 
...
saveRDS(params, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Lifetime_Smoking/dataframes/params_Lifetime_HIPadjBMI.rds")
saveRDS(X_end, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Lifetime_Smoking/dataframes/X_Lifetime_HIPadjBMI.rds")
...
write.table(Lifetime_pruned, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Lifetime_Smoking/dataframes/Lifetime_HIPadjBMI_PRUNED.txt", col.names = TRUE, row.names = FALSE, quote = FALSE)

#################
#Let's run CAUSE#
#################

top_Lifetime_pruned_df <- read.table("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Lifetime_Smoking/dataframes/Lifetime_HIPadjBMI_PRUNED.txt", header = TRUE, stringsAsFactors = FALSE)
...
saveRDS(res, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Lifetime_Smoking/dataframes/RES_Lifetime_to_HIPadjBMI_FULL.rds")

res <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Lifetime_Smoking/dataframes/RES_Lifetime_to_HIPadjBMI_FULL.rds")

res$elpd

#model1  model2    delta_elpd se_delta_elpd             z
#1    null sharing -0.7140026724     1.5259410 -0.4679097518
#2    null  causal -0.7134968848     2.0649045 -0.3455350468
#3 sharing  causal  0.0005057875     0.5428509  0.0009317246

#Sounds really promising:

summary(res)

#p-value testing that causal model is a better fit:  0.5 
#Posterior medians and  95 % credible intervals:
#  model     gamma                 eta                   q                 
#[1,] "Sharing" NA                    "-0.17 (-0.9, 0.06)"  "0.2 (0.01, 0.77)"
#[2,] "Causal"  "-0.05 (-0.23, 0.13)" "-0.01 (-0.72, 0.63)" "0.2 (0.01, 0.86)"

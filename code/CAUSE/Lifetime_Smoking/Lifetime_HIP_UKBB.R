...
#We are going to run CAUSE for Lifetime smoking as exposure and HIP as outcome
...
X <- gwas_merge(Lifetime_, HIP, snp_name_cols = c("chr_pos", "chr_pos"), 
...
HIP[which(HIP$chr_pos == "1:693731"),] #PERFECT. Also checked in PS.
...
#Unfortunately, these fellas are also in the same format in HIP data!
...
X_not_clean$snp <- HIP_not_clean$SNP
...
saveRDS(params, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Lifetime_Smoking/dataframes/params_Lifetime_HIP_UKBB.rds")
saveRDS(X_end, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Lifetime_Smoking/dataframes/X_LifetimeInit_HIP_UKBB.rds")
...
write.table(Lifetime_pruned, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Lifetime_Smoking/dataframes/Lifetime_HIP_UKBB_PRUNED.txt", col.names = TRUE, row.names = FALSE, quote = FALSE)

#################
#Let's run CAUSE#
#################

top_Lifetime_pruned_df <- read.table("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Lifetime_Smoking/dataframes/Lifetime_HIP_UKBB_PRUNED.txt", header = TRUE, stringsAsFactors = FALSE)
...
saveRDS(res, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Lifetime_Smoking/dataframes/RES_Lifetime_to_HIP_UKBB_FULL.rds")

res <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Lifetime_Smoking/dataframes/RES_Lifetime_to_HIP_UKBB_FULL.rds")

res$elpd

#model1  model2 delta_elpd se_delta_elpd         z
#1    null sharing -78.447308    10.0062809 -7.839807
#2    null  causal -79.783581    10.2267541 -7.801457
#3 sharing  causal  -1.336272     0.2337492 -5.716694

#Sounds really promising:

summary(res)

#p-value testing that causal model is a better fit:  5.4e-09 
#Posterior medians and  95 % credible intervals:
#  model     gamma               eta                 q                  
#[1,] "Sharing" NA                  "0.27 (0.22, 0.31)" "0.95 (0.83, 0.99)"
#[2,] "Causal"  "0.26 (0.18, 0.33)" "0 (-0.31, 0.31)"   "0.19 (0, 0.86)"   

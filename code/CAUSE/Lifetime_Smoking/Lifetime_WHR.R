...
#check <- fread("C:/Users/zlc436/Downloads/Lifetime_Smoking.txt") #this was just to check that the download worked.
...
#Lifetime$BETA_SD <- ((Lifetime$BETA)/(0.6940093))
#Lifetime$SE_SD <- ((Lifetime$SE)/(0.6940093))
...
checkio <- fread("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Lifetime_Smoking/snp_nexus/lifetime_WHR_4_nexus.txt", header = FALSE)
...
swapping_snps_2_in_lifetime <- swapping_snps_2[which(swapping_snps_2$new_rs%in%Lifetime_$SNP),] #116 do not need to be changed. Why? Because GIANT has already those. And lifetime too.

#HENCE, lifetime old are those that need to be changed!!

swapping_snps_2_in_lifetime_old <- swapping_snps_2[which(swapping_snps_2$old_rs%in%Lifetime_$SNP),] #Only 1.
...
X_UKBB <- gwas_merge(Lifetime_, WHR_, snp_name_cols = c("chr_pos", "chr_pos"), 
...
saveRDS(params, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Lifetime_Smoking/dataframes/params_Lifetime_WHR_JULY.rds")
saveRDS(X_end, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Lifetime_Smoking/dataframes/X_Lifetime_WHR_JULY.rds")

X_end <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Lifetime_Smoking/dataframes/X_Lifetime_WHR_JULY.rds")
params <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Lifetime_Smoking/dataframes/params_Lifetime_WHR_JULY.rds")
...
write.table(Lifetime_pruned, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Lifetime_Smoking/dataframes/Lifetime_WHR_PRUNED_JULY.txt", col.names = TRUE, row.names = FALSE, quote = FALSE)
...
top_Lifetime_pruned_df <- read.table("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Lifetime_Smoking/dataframes/Lifetime_WHR_PRUNED_JULY.txt", header = TRUE, stringsAsFactors = FALSE)
...
saveRDS(res, file = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Lifetime_Smoking/dataframes/RES_Lifetime_to_WHR_FULL_JULY.rds")

res <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/CAUSE/Lifetime_Smoking/dataframes/RES_Lifetime_to_WHR_FULL_JULY.rds")

res$elpd

#model1  model2  delta_elpd se_delta_elpd          z
#1    null sharing -194.826542    15.6018690 -12.487385
#2    null  causal -196.283958    15.8043048 -12.419652
#3 sharing  causal   -1.457416     0.3095957  -4.707482

#Sounds really promising:

summary(res)

#p-value testing that causal model is a better fit:  1.3e-06 
#Posterior medians and  95 % credible intervals:
#  model     gamma               eta                 q               
#[1,] "Sharing" NA                  "0.36 (0.32, 0.39)" "0.98 (0.93, 1)"
#[2,] "Causal"  "0.35 (0.29, 0.41)" "0 (-0.29, 0.27)"   "0.18 (0, 0.86)"

...
common_snps <- Reduce(intersect, list(cigday_loci_aligned$chr_pos, whradjbmi_loci_aligned$chr_pos , cortisol_loci_aligned$chr_pos)) #637

#And finally we do the match:

cigday_loci_aligned_match <- cigday_loci_aligned[which(cigday_loci_aligned$chr_pos%in%common_snps),] #762
whradjbmi_loci_aligned_match <- whradjbmi_loci_aligned[which(whradjbmi_loci_aligned$chr_pos%in%common_snps),] #762
#shbg_loci_aligned_match <- shbg_loci_aligned[which(shbg_loci_aligned$chr_pos%in%common_snps),] #762
cortisol_loci_aligned_match <- cortisol_loci_aligned[which(cortisol_loci_aligned$chr_pos%in%common_snps),] #762
...
fwrite(final_df, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/Colocalization/Colocalization/info_4_loci/1_ss_of_all_traits/15_78396129_79396129_no_shbg.txt")

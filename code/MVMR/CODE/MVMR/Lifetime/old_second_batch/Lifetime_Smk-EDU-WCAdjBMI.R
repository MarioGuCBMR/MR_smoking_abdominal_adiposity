...
wcadjbmi_proxies_match <- wcadjbmi[which(wcadjbmi$chr_pos_37%in%proxies_chr_pos),] #1838
...
lifetime_proxies_match <- lifetime_smk[which(lifetime_smk$chr_pos%in%wcadjbmi_proxies_match$chr_pos_37),] #1800/1838
...
####################################################################
#Now we need to get the data from wcadjbmi aligned and curated too#
####################################################################

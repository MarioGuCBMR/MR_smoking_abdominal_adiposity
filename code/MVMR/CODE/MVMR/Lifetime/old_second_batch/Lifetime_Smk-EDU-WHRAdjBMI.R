...
whradjbmi_proxies_match <- whradjbmi[which(whradjbmi$chr_pos_37%in%proxies_chr_pos),] #1838
...
lifetime_proxies_match <- lifetime_smk[which(lifetime_smk$chr_pos%in%whradjbmi_proxies_match$chr_pos_37),] #1800/1838
...
####################################################################
#Now we need to get the data from WHRAdjBMI aligned and curated too#
####################################################################
...
whradjbmi_outcome <- whradjbmi[which(whradjbmi$MarkerName%in%lifetime_edu_independent$SNP),] #206/206
...
BYG <- whradjbmi_outcome$final_beta

seBYG <- whradjbmi_outcome$se

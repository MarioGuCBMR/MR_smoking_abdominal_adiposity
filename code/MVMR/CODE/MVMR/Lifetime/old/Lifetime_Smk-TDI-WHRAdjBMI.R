...
#just gonna use TDI as an additional risk factor.
...
mvmr_Mario <- function(dat, outcome, path_){
  ...
  seBXGs = cbind(dat$se.smk, dat$se.TDI)
  ...
  BXGs <- cbind(dat$beta.smk, dat$beta.TDI)
  ...
  colnames(IV_df) <- c("Smoking_mF", "TDI_mF", "Number of SNPs")
  ...
  rownames(results_ivw_original_all) <-  c("SMK_0", "TDI_0", "SMK_0.05", "TDI_0.05", "SMK_0.10", "TDI_0.10", "SMK_0.15", "TDI_0.15", "SMK_20", "TDI_20", "SMK_25", "TDI_25")
  ...
  seBXGs_0 = cbind(dat_q_10_0$se.smk, dat_q_10_0$se.TDI)
  seBXGs_0.05 = cbind(dat_q_10_0.05$se.smk, dat_q_10_0.05$se.TDI)
  seBXGs_0.10 = cbind(dat_q_10_0.10$se.smk, dat_q_10_0.10$se.TDI)
  seBXGs_0.15 = cbind(dat_q_10_0.15$se.smk, dat_q_10_0.15$se.TDI)
  seBXGs_0.20 = cbind(dat_q_10_0.20$se.smk, dat_q_10_0.20$se.TDI)
  seBXGs_0.25 = cbind(dat_q_10_0.25$se.smk, dat_q_10_0.25$se.TDI)
  ...
  BXGs_0 <- cbind(dat_q_10_0$beta.smk, dat_q_10_0$beta.TDI)
  ...
  BXGs_0.05 <- cbind(dat_q_10_0.05$beta.smk, dat_q_10_0.05$beta.TDI)
  ...
  BXGs_0.10 <- cbind(dat_q_10_0.10$beta.smk, dat_q_10_0.10$beta.TDI)
  ...
  BXGs_0.15 <- cbind(dat_q_10_0.15$beta.smk, dat_q_10_0.15$beta.TDI)
  ...
  BXGs_0.20 <- cbind(dat_q_10_0.20$beta.smk, dat_q_10_0.20$beta.TDI)
  ...
  BXGs_0.25 <- cbind(dat_q_10_0.25$beta.smk, dat_q_10_0.25$beta.TDI)
  ...
  colnames(IV_df_q_10) <- c("Smoking_mF_lax_outlier_out", "TDI_mF_lax_outliers_out", "Number_of_SNPs_lax_outliers_out")
  ...
  colnames(results_ivw_q_10_all) <-  c("Estimate_lax_outlier_out", "Std. Error_lax_outlier_out", "t value_lax_outlier_out", "Pr(>|t|)_lax_outlier_TDI")
  rownames(results_ivw_q_10_all) <-  c("SMK_0", "TDI_0", "SMK_0.05", "TDI_0.05", "SMK_0.10", "TDI_0.10", "SMK_0.15", "TDI_0.15", "SMK_0.20", "TDI_0.20", "SMK_0.25", "TDI_0.25")
  ...
  seBXGs_0 = cbind(dat_q_3.84_0$se.smk, dat_q_3.84_0$se.TDI)
  seBXGs_0.05 = cbind(dat_q_3.84_0.05$se.smk, dat_q_3.84_0.05$se.TDI)
  seBXGs_0.10 = cbind(dat_q_3.84_0.10$se.smk, dat_q_3.84_0.10$se.TDI)
  seBXGs_0.15 = cbind(dat_q_3.84_0.15$se.smk, dat_q_3.84_0.15$se.TDI)
  seBXGs_0.20 = cbind(dat_q_3.84_0.20$se.smk, dat_q_3.84_0.20$se.TDI)
  seBXGs_0.25 = cbind(dat_q_3.84_0.25$se.smk, dat_q_3.84_0.25$se.TDI)
  ...
  BXGs_0 <- cbind(dat_q_3.84_0$beta.smk, dat_q_3.84_0$beta.TDI)
  colnames(BXGs_0) <- c("1", "2")
  ...
  BXGs_0.05 <- cbind(dat_q_3.84_0.05$beta.smk, dat_q_3.84_0.05$beta.TDI)
  colnames(BXGs_0.05) <- c("1", "2")
  ...
  BXGs_0.10 <- cbind(dat_q_3.84_0.10$beta.smk, dat_q_3.84_0.10$beta.TDI)
  colnames(BXGs_0.10) <- c("1", "2")
  ...
  BXGs_0.15 <- cbind(dat_q_3.84_0.15$beta.smk, dat_q_3.84_0.15$beta.TDI)
  colnames(BXGs_0.15) <- c("1", "2")
  ...
  BXGs_0.20 <- cbind(dat_q_3.84_0.20$beta.smk, dat_q_3.84_0.20$beta.TDI)
  colnames(BXGs_0.20) <- c("1", "2")
  ...
  BXGs_0.25 <- cbind(dat_q_3.84_0.25$beta.smk, dat_q_3.84_0.25$beta.TDI)
  colnames(BXGs_0.25) <- c("1", "2")
  ...
  colnames(IV_df_q_3.84) <- c("Smoking_mF_strict_outlier_out", "TDI_mF_strict_outliers_out", "Number_of_SNPs_strict_outliers_out")
  ...
  colnames(results_ivw_q_3.84_all) <-  c("Estimate_strict_outlier_out", "Std. Error_strict_outlier_out", "t value_strict_outlier_out", "Pr(>|t|)_strict_outlier_TDI")
  rownames(results_ivw_q_3.84_all) <-  c("SMK_0", "TDI_0", "SMK_0.05", "TDI_0.05", "SMK_0.10", "TDI_0.10", "SMK_0.15", "TDI_0.15", "SMK_0.20", "TDI_0.20", "SMK_0.25", "TDI_0.25")
...
lifetime_TDI_df <- fread("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/Curated_data/LifeTime_TDI_Risk_Factors.txt") #119

##############################
#Let's do some checks here...#
##############################

length(which(lifetime_TDI_df$pval.smk < 0.00000005)) #109
length(which(lifetime_TDI_df$pval.tdi < 0.00000005)) #10

#this seems suspicious...

lifetime_TDI_df[which.min(lifetime_TDI_df$pval.smk),]
...
whradjbmi_match <- whradjbmi[which(whradjbmi$chr_pos_37%in%lifetime_TDI_df$chr_pos),] #55
check <- whradjbmi[which(whradjbmi$MarkerName%in%lifetime_TDI_df$SNP),] #55 too

#That means that we need to run proxies for about 60 SNPs.
#Let's go:

missings_snps <- lifetime_TDI_df[which(!(lifetime_TDI_df$chr_pos%in%whradjbmi$chr_pos_37)),]

#Let's check which of the SNPs are from which dataframe.

missing_lifetime <- missings_snps[which(missings_snps$source == "Lifetime"),] #61/64
missing_TDI <- missings_snps[which(missings_snps$source == "tdi"),] #3/64

#This sums 64. Now is perfect.

########################################################################
#We are gonna save the missing snps to compare them with other outcomes#
########################################################################

#Since WHR, WHRAdjBMI, WC and WCAdjBMI come from the same study, the possiblity that the mising SNPs are
#the same is really high.

fwrite(missings_snps, "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/CODE/Lifetime/proxies/storage/Lifetime_TDI/WHRAdjBMI/missing_snps.txt")

#####################################
#Great, now let's detect the proxies#
#####################################

#LDproxy_batch works saving the proxies in the working directory, so we need to set it up...

getwd() #I opened it in the wrong place!

setwd("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/CODE/Lifetime/proxies/storage/Lifetime_TDI/WHRAdjBMI/")

#And now we are going to get the proxies:

LDlinkR::LDproxy_batch(snp = missings_snps$chr_pos, pop = "EUR", r2d = "r2", append = TRUE, token = "04cad4ca4374")

#Now let's get them (I have added a column for the rows, which make them difficult to load)

proxies_df <- fread("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/CODE/Lifetime/proxies/storage/Lifetime_TDI/WHRAdjBMI/combined_query_snp_list.txt", fill = TRUE)
...
proxies_df_clean_curated <- proxies_df_clean[which(proxies_df_clean$R2 > 0.8),] #1680

#Now we are gonna divide the SNPs depending on the query, whether it was from lifetime or it was from TDIcation.

proxies_df_lifetime <- proxies_df_clean_curated[which(proxies_df_clean_curated$query_snp%in%missing_lifetime$chr_pos),] #1579
proxies_df_TDI <- proxies_df_clean_curated[which(proxies_df_clean_curated$query_snp%in%missing_TDI$chr_pos),] #101

###############################################
#Let's get those that are present in WHRAdjBMI#
###############################################

whradjbmi_proxies_match_lifetime <- whradjbmi[which(whradjbmi$chr_pos_37%in%proxies_df_lifetime$Coord),] #500
whradjbmi_proxies_match_TDI <- whradjbmi[which(whradjbmi$chr_pos_37%in%proxies_df_TDI$Coord),] #47

#This is going to be always the final threshold since WHRAdjBMI is a bottleneck. Hence...
#we are gonna use these SNPs to match the rest:

lifetime_proxies_match <- lifetime_smk[which(lifetime_smk$chr_pos%in%whradjbmi_proxies_match_lifetime$chr_pos_37),] #496

summary(lifetime_proxies_match$EAF) #perfect

#And now we retrieve the TDI proxies.
...
TDI_proxies_match <- extract_outcome_data(
  snps = whradjbmi_proxies_match_TDI$MarkerName,
  outcomes = 'ukb-b-16489',
  proxies = FALSE
)

TDI_proxies_match <- TDI_proxies_match[which(TDI_proxies_match$eaf.outcome > 0.01),]
TDI_proxies_match <- TDI_proxies_match[which(TDI_proxies_match$eaf.outcome < 0.99),]

################################################
#Now we got the data of the SNPs that we want!!#
################################################

#We only require rsid and pval to find the lead proxy via clumping.

#Hence we only need:

#Data from the lifetime proxies.
#Data from the TDI proxies.
...
independent_set_TDI <- TDI_proxies_match %>%
  select(SNP, pval.outcome)

colnames(independent_set_TDI) <- c("rsid", "pval")

#Finally we get the data from the original SNPs that are not missing:

lifetime_TDI_df_not_missing <- lifetime_TDI_df[which(lifetime_TDI_df$chr_pos%in%whradjbmi$chr_pos_37),]

#And here we divide too, by those that are genome-wide significant for each of the SNPs.

lifetime_only_not_missing <- lifetime_TDI_df_not_missing[which(lifetime_TDI_df_not_missing$source == "Lifetime"),] #48/55
TDI_only_not_missing <- lifetime_TDI_df_not_missing[which(lifetime_TDI_df_not_missing$source == "tdi"),] #7/55

#########
#FINALLY#
#########

independent_set_TDI_not_missing <- TDI_only_not_missing %>%
  select(SNP, pval.tdi)

colnames(independent_set_TDI_not_missing) <- c("rsid", "pval")
...
independent_final_set <- rbind(independent_set_lifetime, independent_set_TDI, independent_set_lifetime_not_missing, independent_set_TDI_not_missing) #A total of 1911 SNPs.

############################################
#BEFORE THIS WE ARE GONNA CHECK THE ALLELES#
############################################

proxies_check <- proxies_df_clean_curated[which(proxies_df_clean_curated$RS_Number%in%independent_final_set$rsid),]

#543/598. Only missing the 55 that are not missing. 

proxies_check <- proxies_check[order(proxies_check$Correlated_Alleles),]

head(proxies_check) #all good
tail(proxies_check) #all good.
...
#2. Then we checked how many of those are in WHRAdjBMI because it is the bottleneck.
#3. Then, we checked how many of those are present in lifetime smoking
#4. And how many of those are in TDI.
#5. Now we need to merge the data between lifetime and TDI.

#It seems that we have a duplicate.

#The next step is to obtain a dataframe with all the data for the proxies.
#And combine it with the original lifetime_TDI data.
...
dat_1_smk2TDI_proxies <- harmonise_data(lifetime_proxies_match, TDI_proxies_match, action = 3) #We have a duplicate here...

#Some are palindromic. 
#Let's be wary!!

dat_1_smk2TDI_proxies <- dat_1_smk2TDI_proxies[which(dat_1_smk2TDI_proxies$palindromic == FALSE),]
dat_1_smk2TDI_proxies <- dat_1_smk2TDI_proxies[which(dat_1_smk2TDI_proxies$remove == FALSE),] #it removes the incompatible triallelic combination. But keeps the good ones. That is our boy!!

#With this version we get 100 SNPs...

dat_1_smk2TDI_proxies$samplesize.exposure <- 462690

dat_1_smk2TDI_proxies_clean <- dat_1_smk2TDI_proxies %>%
...
colnames(dat_1_smk2TDI_proxies_clean) <- c("chr_pos", "SNP", "effect_allele", "other_allele", "eaf.smk", "beta.smk", "se.smk", "pval.smk", "samplesize.smk", "eaf.TDI", "beta.TDI", "se.TDI", "pval.TDI", "samplesize.TDI")

lifetime_TDI_independent <- dat_1_smk2TDI_proxies_clean
...
whradjbmi_outcome <- whradjbmi[which(whradjbmi$MarkerName%in%lifetime_TDI_independent$SNP),] #199/200

length(which(whradjbmi_outcome$MarkerName%in%lifetime_TDI_independent$SNP)) #all of them!

#Let's take out the duplicate according to TDIcation pvalue:

lifetime_TDI_independent <- lifetime_TDI_independent[order(lifetime_TDI_independent$pval.TDI),]

lifetime_TDI_independent <- lifetime_TDI_independent[-which(duplicated(lifetime_TDI_independent$SNP) == TRUE),]

#1. we order the SNPs:

whradjbmi_outcome <- whradjbmi_outcome[order(match(whradjbmi_outcome$MarkerName, lifetime_TDI_independent$SNP)),]

#Let's check this:

length(which(whradjbmi_outcome$MarkerName != lifetime_TDI_independent$SNP)) #0
length(which(whradjbmi_outcome$MarkerName == lifetime_TDI_independent$SNP)) #206

length(which(whradjbmi_outcome$chr_pos_37 != lifetime_TDI_independent$chr_pos)) #0
length(which(whradjbmi_outcome$MarkerName == lifetime_TDI_independent$SNP)) #206
...
whradjbmi_outcome$final_a1 <- ifelse(whradjbmi_outcome$Allele1 != lifetime_TDI_independent$effect_allele, whradjbmi_outcome$Allele2, whradjbmi_outcome$Allele1)
whradjbmi_outcome$final_a2 <- ifelse(whradjbmi_outcome$Allele1 != lifetime_TDI_independent$effect_allele, whradjbmi_outcome$Allele1, whradjbmi_outcome$Allele2)
whradjbmi_outcome$final_beta <- ifelse(whradjbmi_outcome$Allele1 != lifetime_TDI_independent$effect_allele, whradjbmi_outcome$b*(-1), whradjbmi_outcome$b)
whradjbmi_outcome$final_eaf <- ifelse(whradjbmi_outcome$Allele1 != lifetime_TDI_independent$effect_allele, 1-whradjbmi_outcome$FreqAllele1HapMapCEU, whradjbmi_outcome$FreqAllele1HapMapCEU)

#Let's check:

length(which(whradjbmi_outcome$final_a1 != lifetime_TDI_independent$effect_allele)) #0
length(which(whradjbmi_outcome$final_a1 == lifetime_TDI_independent$effect_allele)) #206

length(which(whradjbmi_outcome$final_a2 != lifetime_TDI_independent$other_allele)) #0
length(which(whradjbmi_outcome$final_a2 == lifetime_TDI_independent$other_allele)) #206

head(whradjbmi_outcome) #worked like a charm. 
...
path_ <- "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/CODE/Lifetime/proxies/storage/Lifetime_TDI/WHRAdjBMI/"

mvmr_Mario(lifetime_TDI_independent, whradjbmi_outcome, path_)

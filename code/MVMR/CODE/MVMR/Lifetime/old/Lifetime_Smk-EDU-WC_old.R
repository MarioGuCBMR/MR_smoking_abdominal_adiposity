...
WC_match <- WC[which(WC$chr_pos_37%in%lifetime_edu_df$chr_pos),] #108
check <- WC[which(WC$MarkerName%in%lifetime_edu_df$SNP),] #108 too.
...
WC_proxies_match <- WC[which(WC$chr_pos_37%in%proxies_chr_pos),] #1804
...
lifetime_proxies_match <- lifetime_smk[which(lifetime_smk$chr_pos%in%WC_proxies_match$chr_pos_37),] #1766/1804

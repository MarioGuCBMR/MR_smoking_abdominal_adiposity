...
whr_proxies_match_lifetime <- whr[which(whr$chr_pos_37%in%proxies_df_lifetime$Coord),] #229
whr_proxies_match_edu <- whr[which(whr$chr_pos_37%in%proxies_df_edu$Coord),] #1609
...
lifetime_proxies_match <- lifetime_smk[which(lifetime_smk$chr_pos%in%whr_proxies_match_lifetime$chr_pos_37),] #229
...
whr_outcome <- whr[which(whr$MarkerName%in%lifetime_edu_independent$SNP),] #199/200
...
length(which(whr_outcome$MarkerName == lifetime_edu_independent$SNP)) #199
...
length(which(whr_outcome$final_a1 == lifetime_edu_independent$effect_allele)) #199

length(which(whr_outcome$final_a2 != lifetime_edu_independent$other_allele)) #0
length(which(whr_outcome$final_a2 == lifetime_edu_independent$other_allele)) #199

...
pleiotropy_data_whr <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/CODE/MVMR/Lifetime/OUTPUT/WHR/conditional_mF_cochrans_Q")
pleiotropy_data_whradjbmi <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/CODE/MVMR/Lifetime/OUTPUT/WHRAdjBMI/conditional_mF_cochrans_Q")
pleiotropy_data_wc <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/CODE/MVMR/Lifetime/OUTPUT/WC/conditional_mF_cochrans_Q")
pleiotropy_data_wcadjbmi <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/CODE/MVMR/Lifetime/OUTPUT/WCAdjBMI/conditional_mF_cochrans_Q")
pleiotropy_data_hip <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/CODE/MVMR/Lifetime/OUTPUT/HIP/conditional_mF_cochrans_Q")
pleiotropy_data_hipadjbmi <- readRDS("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/CODE/MVMR/Lifetime/OUTPUT/HIPAdjBMI/conditional_mF_cochrans_Q")

#########################
#Getting the paths ready#
#########################

path_whr <- "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/OUTPUT/Lifetime_results/WHR/WHR_"
path_wc <- "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/OUTPUT/Lifetime_results/WC/WC_"
path_whradjbmi <- "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/OUTPUT/Lifetime_results/WHRAdjBMI/WHRAdjBMI_"
path_wcadjbmi <- "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/OUTPUT/Lifetime_results/WCAdjBMI/WCAdjBMI_"
path_hip <- "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/OUTPUT/Lifetime_results/HIP/HIP_"
path_hipadjbmi <- "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/OUTPUT/Lifetime_results/HipAdjBMI/HipAdjBMI_"
...
whr_csv <- fread("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/CODE/MVMR/Lifetime/OUTPUT/WHR/mvmr_ivw_results.csv")

#YES!! The data might be weird when seen in excel, but R reads it properly...

#we will save it again to avoid dramas.

whradjbmi_csv <- fread("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/CODE/MVMR/Lifetime/OUTPUT/WHRAdjBMI/mvmr_ivw_results.csv")
wc_csv <- fread("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/CODE/MVMR/Lifetime/OUTPUT/WC/mvmr_ivw_results.csv")
wcadjbmi_csv <- fread("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/CODE/MVMR/Lifetime/OUTPUT/WCAdjBMI/mvmr_ivw_results.csv")

hip_csv <- fread("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/CODE/MVMR/Lifetime/OUTPUT/HIP/mvmr_ivw_results.csv")
hipadjbmi_csv <- fread("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/Mario&German/Smoking_WHR/CODE_4_Replication/MVMR/CODE/MVMR/Lifetime/OUTPUT/HIPAdjBMI/mvmr_ivw_results.csv")

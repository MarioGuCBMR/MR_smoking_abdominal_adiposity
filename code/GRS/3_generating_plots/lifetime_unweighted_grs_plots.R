...
output_path = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/plots/fat_lifetime_smoking_whr_whradjbmi_unweighted_grs_plot.tiff"
tiff(output_path, width = 4200, height=4000, res = 500)
plot_data("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/grs_output/fat_lifetime_whr_grs_res_unweighted.txt",
...
output_path = "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/plots/fatadjbmi_lifetime_smoking_whr_whradjbmi_unweighted_grs_plot.tiff"
tiff(output_path, width = 4200, height=4000, res = 500)
plot_data("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/grs_output/fatadjbmi_lifetime_whr_grs_res_unweighted.txt",

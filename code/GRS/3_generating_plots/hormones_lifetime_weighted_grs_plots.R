...
# HORMONES GRS
whr_path <- "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/grs_output/hormones_lifetime_whr_grs_res_weighted.txt"
...
output_path= "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/plots/hormones_lifetime_smoking_whr_whradjbmi_weighted_grs_plot.tiff"
...
plotio <-
  ...
  scale_shape_manual(name= "GRS", values=c("Lifetime smoking-WHRadjBMI GRS" = 17, "Lifetime smoking-WHR GRS" = 15)) +
  scale_color_manual(name = "Trait", values = c("red", "blue", "green")) + 
  scale_y_continuous(breaks = scales::pretty_breaks(n = 5))+
  ...
  guides(fill = FALSE, color = guide_legend(title = "GRS"))

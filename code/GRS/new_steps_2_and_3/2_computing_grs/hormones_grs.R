...
computing_grs <- function(smoking_data, 
  ...
  cortisol_2_initiation_ordered <- cortisol_2_initiation[order(cortisol_2_initiation$variant),]
  oestradiol_2_initiation_ordered <- oestradiol_2_initiation[order(oestradiol_2_initiation$variant),]
  testosterone_2_initiation_ordered <- testosterone_2_initiation[order(testosterone_2_initiation$variant),]
  shbg_2_initiation_ordered <- shbg_2_initiation[order(shbg_2_initiation$variant),]
...
oestradiol <- "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/curated_summary_statistics/curated_estradiol.txt"

...
computing_grs <- function(smoking_data, 
  ...
  vatadjbmi <- fread(trait7)
  asatadjbmi <- fread(trait8)
  gfatadjbmi <- fread(trait9)
  ...
  vatadjbmi_2_initiation <- smoking_aligner(smoking_initiation, vatadjbmi) #76
  asatadjbmi_2_initiation <- smoking_aligner(smoking_initiation, asatadjbmi) #76
  gfatadjbmi_2_initiation <- smoking_aligner(smoking_initiation, gfatadjbmi) #76
  ...
  vatadjbmi_2_initiation_ordered <- vatadjbmi_2_initiation[order(vatadjbmi_2_initiation$variant),]
  asatadjbmi_2_initiation_ordered <- asatadjbmi_2_initiation[order(asatadjbmi_2_initiation$variant),]
  gfatadjbmi_2_initiation_ordered <- gfatadjbmi_2_initiation[order(gfatadjbmi_2_initiation$variant),]
  ...
  print(length(which(smoking_initiation_match_ordered$effect_allele == vatadjbmi_2_initiation_ordered$effect_allele))) #good
  print(length(which(smoking_initiation_match_ordered$effect_allele == asatadjbmi_2_initiation_ordered$effect_allele))) #good
  print(length(which(smoking_initiation_match_ordered$effect_allele == gfatadjbmi_2_initiation_ordered$effect_allele))) #good
  ...
  list_of_traits <- list(vat_2_initiation_ordered, 
                         vatadjbmi_2_initiation_ordered,
                         
                         gfat_2_initiation_ordered,
                         gfatadjbmi_2_initiation_ordered,
                         
                         asat_2_initiation_ordered, 
                         asatadjbmi_2_initiation_ordered, 
                         
                         vatgfat_2_initiation_ordered,
                         vatsat_2_initiation_ordered, 
                         asatgfat_2_initiation_ordered) 
  
  trait_names <- c(name1, name2, name3, name4, name5, name6, name7, name8, name9)
  type_of_trait <- c(name1, name2, name3, name4, name5, name6, name7, name8, name9)
...
computing_grs(smoking_initiation_whr, 
              vat, asat, gfat, vatsat_ratio, asatgfat_ratio, vatgfat_ratio, vatadjbmi, asatadjbmi, gfatadjbmi,

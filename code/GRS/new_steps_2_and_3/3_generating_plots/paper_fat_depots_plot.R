...
plot_data_initiation <- function(whr_path, whradjbmi_path, title1, title2, level1, level2, level3, level4, level5, level6, level7, level8, level9, main_title){ # , out_initiation_fat
  ...
  # fwrite(grs_df, out_initiation_fat)
...
plot_data_lifetime <- function(whr_path, whradjbmi_path, title1, title2, level1, level2, level3, level4, level5, level6, level7, level8, level9, main_title){ # out_initiation_fat
  whr_w_grs_df <- fread(whr_path)
  whradjbmi_w_grs_df <- fread(whradjbmi_path)
...
output_path <- "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/plots/final_fat_lifetime_AND_smoking_initiation_whr_whradjbmi_weighted_grs_plot.tiff"

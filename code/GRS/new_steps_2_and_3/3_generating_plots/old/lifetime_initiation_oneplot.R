...
plot_data_initiation <- function(whr_path, whradjbmi_path, title1, title2, level1, level2, level3, level4, level5, level6, level7, level8, level9, main_title){
...
plot_data_lifetime <- function(whr_path, whradjbmi_path, title1, title2, level1, level2, level3, level4, level5, level6, level7, level8, level9, main_title){
  whr_w_grs_df <- fread(whr_path)
  whradjbmi_w_grs_df <- fread(whradjbmi_path)
...
tiff(output_path, width = 4200, height=6000, res = 500)

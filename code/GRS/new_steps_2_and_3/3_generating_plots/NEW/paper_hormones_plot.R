...
plot_data_initiation <- function(whradjbmi_path, title1, 
  ...
  grs_df <- grs_df %>%
    mutate(
      betas_rounded = ifelse(round(beta, 2) != 0, round(beta, 2), round(beta, 3)),
  ...
  grs_df$full_effect <- paste(grs_df$betas_rounded,
                              " (",
                              grs_df$lower_ci_rounded,
                              ", ",
                              grs_df$upper_ci_rounded,
                              ")",
                              sep=""
  )
...
plot_data_lifetime <- function(whradjbmi_path, title1, level1, level2, level3, level4, main_title, output_table){
...
p1 <- plot_data_lifetime("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/grs_output/hormones_lifetime_whradjbmi_grs_res_weighted.txt",
                         ...
                         "Lifetime smoking", 
                         "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/plots/MANUSCRIPT/Hormones_Lifetime.csv")
...
p2 <- plot_data_initiation("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/grs_output/hormones_smoking_initiation_whradjbmi_grs_res_weighted.txt",
                           ...
                           "Cortisol", "Oestradiol", "Testosterone", "SHBG",
                           "Smoking initiation", 
                           "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/plots/MANUSCRIPT/Hormones_Initiation.csv")
...
output_path <- "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/plots/MANUSCRIPT/final_hormones_lifetime_AND_smoking_initiation_whradjbmi_weighted_grs_plot.tiff"

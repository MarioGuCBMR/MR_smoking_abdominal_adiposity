...
# install.packages("J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/gtx_0.0.8.tar.gz", repos = NULL, type = "source")
...
computing_grs <- function(smoking_data, 
  ...
  vatsat_ratio <- fread(trait4)
  asatgfat_ratio <- fread(trait5)
  vatgfat_ratio <- fread(trait6)
  ...
  vatsat_2_initiation <- smoking_aligner(smoking_initiation, vatsat_ratio) #76
  asatgfat_2_initiation <- smoking_aligner(smoking_initiation, asatgfat_ratio) #76
  vatgfat_2_initiation <- smoking_aligner(smoking_initiation, vatgfat_ratio) #76
  ...
  vatgfat_2_initiation_ordered <- vatgfat_2_initiation[order(vatgfat_2_initiation$variant),]
  vatsat_2_initiation_ordered <- vatsat_2_initiation[order(vatsat_2_initiation$variant),]
  asatgfat_2_initiation_ordered <- asatgfat_2_initiation[order(asatgfat_2_initiation$variant),]
  ...
  print(length(which(smoking_initiation_match_ordered$effect_allele == vatsat_2_initiation_ordered$effect_allele))) #good
  print(length(which(smoking_initiation_match_ordered$effect_allele == asatgfat_2_initiation_ordered$effect_allele))) #good
  print(length(which(smoking_initiation_match_ordered$effect_allele == vatgfat_2_initiation_ordered$effect_allele))) #good
  ...
  list_of_traits <- list(vat_2_initiation_ordered, 
                         ...
                         vatsat_2_initiation_ordered, 
                         asatgfat_2_initiation_ordered,
                         vatgfat_2_initiation_ordered) 
  
  trait_names <- c(name1, name2, name3, name4, name5, name6)
  type_of_trait <- c(name1, name2, name3, name4, name5, name6)
...
vat <- "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/curated_summary_statistics/vat.txt"
asat <- "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/curated_summary_statistics/asat.txt"
gfat <- "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/curated_summary_statistics/gfat.txt"

vatsat_ratio <- "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/curated_summary_statistics/vatAsatRatio.txt"
asatgfat_ratio <- "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/curated_summary_statistics/asatGfatRatio.txt"
vatgfat_ratio <- "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/curated_summary_statistics/vatGfatRatio.txt"

vatadjbmi <- "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/curated_summary_statistics/vatadjbmi.txt"
asatadjbmi <- "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/curated_summary_statistics/asatadjbmi.txt"
gfatadjbmi <- "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/curated_summary_statistics/gfatadjbmi.txt"

# CALL
### 1. FAT DEPOTS
computing_grs(smoking_initiation_whr, 
              vat, asat, gfat, vatsat_ratio, asatgfat_ratio, vatgfat_ratio, 
              "VAT", "ASAT", "GSAT", "VAT/ASAT","ASAT/GSAT","VAT/GSAT",
              "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/grs_output/fat_smoking_initiation_whr_grs_res_unweighted.txt",
              "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/grs_output/fat_smoking_initiation_whr_grs_res_weighted.txt")
...
computing_grs(lifetime_smoking_whr, 
              vat, asat, gfat, vatsat_ratio, asatgfat_ratio, vatgfat_ratio, 
              "VAT", "ASAT", "GSAT", "VAT/ASAT","ASAT/GSAT","VAT/GSAT",
              "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/grs_output/fat_lifetime_whr_grs_res_unweighted.txt",
              "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/grs_output/fat_lifetime_whr_grs_res_weighted.txt")

computing_grs(lifetime_smoking_whradjbmi, 
              vat, asat, gfat, vatsat_ratio, asatgfat_ratio, vatgfat_ratio, 
              "VAT", "ASAT", "GSAT", "VAT/ASAT","ASAT/GSAT","VAT/GSAT",
              "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/grs_output/fat_lifetime_whradjbmi_grs_res_unweighted.txt",
...
### 2. FAT DEPOTS ADJ BMI
computing_grs(smoking_initiation_whr, 
              vatadjbmi, asatadjbmi, gfatadjbmi, vatsat_ratio, asatgfat_ratio, vatgfat_ratio, 
              "VATadjBMI", "ASATadjBMI", "GSATadjBMI", "VAT/ASAT","ASAT/GSAT","VAT/GSAT",
              "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/grs_output/fatadjbmi_smoking_initiation_whr_grs_res_unweighted.txt",
              "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/grs_output/fatadjbmi_smoking_initiation_whr_grs_res_weighted.txt")
...
computing_grs(smoking_initiation_whradjbmi, 
              ...
              "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/grs_output/fatadjbmi_smoking_initiation_whradjbmi_grs_res_weighted.txt")

computing_grs(lifetime_smoking_whr, 
              vatadjbmi, asatadjbmi, gfatadjbmi, vatsat_ratio, asatgfat_ratio, vatgfat_ratio, 
              "VATadjBMI", "ASATadjBMI", "GSATadjBMI", "VAT/ASAT","ASAT/GSAT","VAT/GSAT",
              "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/grs_output/fatadjbmi_lifetime_whr_grs_res_unweighted.txt",
              "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/grs_output/fatadjbmi_lifetime_whr_grs_res_weighted.txt")

computing_grs(lifetime_smoking_whradjbmi, 
              vatadjbmi, asatadjbmi, gfatadjbmi, vatsat_ratio, asatgfat_ratio, vatgfat_ratio, 
              "VATadjBMI", "ASATadjBMI", "GSATadjBMI", "VAT/ASAT","ASAT/GSAT","VAT/GSAT",
              "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/grs_output/fatadjbmi_lifetime_whradjbmi_grs_res_unweighted.txt",
              "J:/CBMR/SUN-CBMR-Kilpelainen-Group/Team projects/German&Mario&MariaJose/data/grs_output/fatadjbmi_lifetime_whradjbmi_grs_res_weighted.txt")
